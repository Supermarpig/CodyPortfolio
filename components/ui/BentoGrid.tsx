...
export const BentoGridItem = ({
    ...
    const rightLists = ["MongoDB", "NextJS", "NodeJS"];
    ...
    const handleCopy = () => {
        const text = "iharshitjaiswal@gmail.com";
            ...
            <div className={`${id === 6 && "flex justify-center"} h-full`}>
                <div className="w-full h-full absolute">
                    {img && (
                        <img
                            src={img}
                            alt={img}
                            className={cn(imgClassName, "object-cover ,object-center p-8")}
                        />
                    )}
                </div>
                <div
                ...
                >
                    ...
                    lg:opacity-100 rounded-lg text-center bg-[#10132E]"
                            ...
                            <div className="flex flex-col gap-2 md:gap-3 lg:gap-4 mr-4">
                                <span className="lg:py-5 lg:px-3 sm:py-5 py-2 px-4  rounded-lg text-center bg-[#10132E]"></span>
